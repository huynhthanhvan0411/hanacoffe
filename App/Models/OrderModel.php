...
class OrderModel extends BaseModel
{
    ...
    public function getTotalOrders()
    {
        ...
        if ($query === false) {
            die("Có lỗi trong truy vấn SQL. Vui lòng kiểm tra và thử lại sau."); // Thay thế thông báo lỗi tùy chỉnh tại đây
        }
    ...
    public function getOrderDetailById($id)
    {
        ...
        if ($query === false) {
            die("Query error: Custom error message here"); // Replace with your custom error message
        }
