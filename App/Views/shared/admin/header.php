...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./public/admin/dist/img/iconCf.png">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #f0e5d4;">
            ...
            <a href="./?module=admin&controller=dashboard" class="brand-link">
                <img src="./public/site/img/iconCf.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">HanaCoffe</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="./public/site/img/adminlte.jpg" class="img-circle elevation-2" alt="User Image" style="width: 35px; height: 35px; border-radius: 50%;">
                    </div>
                    <div class="info">
                        <a style="text-align: center; line-height: 20px;" href="#" class="d-block"><?= $_SESSION['user']['fname'] . ' ' . $_SESSION['user']['lname'] ?? null;  ?></a>
                    </div>
                </div>
