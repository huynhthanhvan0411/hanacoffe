...
<div id="id02" class="modal">
    <form action="?controller=verify&action=signup" method="post"
        class="modal-content modal-dialog animate modal-dialog-centered" name="signupForm"
        ...
        <div class="main-form-content">
            ...
            <div class="row mb-3">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Enter First name *" name="fname" id="su-fname"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Enter Last name *" name="lname" id="su-lname"
            ...
            <div class="row mb-3">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Enter Email address *" name="email" id="su-email"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Enter phone number *" name="phone" id="su-phone"
            ...
            <input type="text" class="mb-3" placeholder="Enter address *" name="address" id="su-address"
            ...
            <div class="row mb-3">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="password" placeholder="Enter Password *" name="password" id="su-psw"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="password" placeholder="Repeat Password *" name="password_confirmation" id="su-psw-rep"
                        onkeyup="validateConfirmPassword(this, 'su-psw')">
