...
<head>
    ...
    <title>Hana | Page Not Found</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link rel="icon" type="image/x-icon" href="./public/site/img/iconCf.png">
...
<body>
    ...
    <header class="header">
            ...
            <div class="container-fluid p-0" style="background-color: white;">
                <div class="row contact-block m-0">
                    <ul class="contact-span m-0 hidden-xs hidden-sm">
                        <li><i class="fas fa-map-marker-alt"></i><span>54 Trieu Khuc, Thanh Xuan, Ha Noi</span>
                        </li>
                        <li><i class="fas fa-phone-alt"></i><span>(883) 876 8973</span></li>
                    </ul>
        ...
        <nav class="navbar nav-main navbar-expand-md bg-light navbar-light">
            <div class="logo">
                <a class="navbar-brand" href="./"><img src="./public/site/img/home/logo/logocf2.png" alt="Hana"></a>
            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-7">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a><img src="./public/site/img/home/logo/logo-footer.jpg" alt="" style="width: 111px; height: 56px;"></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-5">
                    <div class="footer__widget">
                        ...
                        <ul id="contact-list">
                            ...
                            <li><span><i class="far fa-envelope"></i>Email:</span><span>hanacoffe@support.com</span>
                            </li>
