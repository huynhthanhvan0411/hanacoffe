...
<section class="checkout p-50">
    <form method="POST" action="?controller=account&module=admin&action=store" name="addAccountForm" id="addAccountForm"
        onsubmit="return validateAddAccountForm();">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 15px">
                    <?php if (!empty($message['all-error'])) { ?>
                    <div class="alert alert-danger" style="margin-bottom: 0;" id="all-error">
                        <button onclick="document.getElementById('all-error').style.display='none'" type="button"
                    ...
                    <div class="alert alert-success" style="margin-bottom: 0;" id="success-update-profile">
                        <button onclick="document.getElementById('success-update-profile').style.display='none'"
                    ...
                    <div class="bill-form-block">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fname" id="fname" class="form-control"
                                    aria-describedby="helpId" onkeyup="validateName(this, 'First name')">
                                <small class="addAccErr" id="fname-err"></small>
                            </div>
                            <div class="col-md-6">
                                <label for="lname">Last name <span class="asterisk">*</span></label>
                                <input type="text" name="lname" id="lname" class="form-control"
                                    aria-describedby="helpId" onkeyup="validateName(this, 'Last name')">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address" class="form-control"
                                aria-describedby="helpId" onkeyup="validateNotEmpty(this, 'Address')">
                    ...
                    <div class="bill-form-block" style="border: none; padding-left: 2rem; padding-right:0">
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control" name="password"
                                autocomplete="current-password" onkeyup="validatePassword(this);">
                        ...
                        <div class="form-group">
                            ...
                            <input id="confirm_password" type="password" class="form-control"
                                ...
                                onkeyup="validateConfirmPassword(this, 'password');">
