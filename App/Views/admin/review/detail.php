...
<form action="./?module=admin&controller=review&action=searchReviewForProductFull&id=<?= $pro['id'] ?>"
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <a href="./?module=admin&controller=review&action=delete&id=<?= $model['id'] ?>&proId=<?= $pro['id'] ?>"
