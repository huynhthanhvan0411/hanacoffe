...
<div class="alert alert-success" id="success-add-banner">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"
        onclick="document.getElementById('success-add-banner').style.display='none'">&times;</button>
    <?= $message ?? 'null' ?>
</div>
<?php } ?>

<form action="./?module=admin&controller=banner&action=store" method="POST" name="bannerForm" role="form"
    enctype="multipart/form-data" onsubmit="return validateBannerForm();">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="ad-bn-cr-description" name="description"
                    placeholder="Banner description" style="height: 46px;"></textarea>
            </div>
        </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="form-group">
                ...
                <input type="number" id="ad-bn-cr-priority" class="form-control" name="priority"
                    placeholder="Input priority" onkeyup="validateInt(this, 'Priority');">
