...
<div class="alert alert-success" id="success-update-banner">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"
        onclick="document.getElementById('success-update-banner').style.display='none'">&times;</button>
    <?= $message ?? '' ?>
</div>
<?php } ?>

<form action="./?module=admin&controller=banner&action=update&id=<?= $_GET['id'] ?>" method="POST" role="form"
    name="bannerForm" enctype="multipart/form-data" onsubmit="return validateBannerEditForm();">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id='ad-bn-ed-name' name="name" placeholder="Input name"
                    value="<?= $banner['name'] ?>" onkeyup="validateNotEmpty(this, 'Banner name');">
            ...
            <div class="form-group">
                ...
                <select name="site" class="form-control" id='ad-bn-ed-site'>
                    ...
                    <option value="Blog Detail" <?= $banner['site'] == 'Blog Detail' ? 'selected' : ''  ?>>Blog Detail
                    </option>
                    <option value="Product" <?= $banner['site'] == 'Product' ? 'selected' : ''  ?>>Product</option>
                    <option value="Product Detail" <?= $banner['site'] == 'Product Detail' ? 'selected' : ''  ?>>Product
                        Detail</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="ad-bn-ed-description" name="description"
                    placeholder="Banner description" style="height: 46px;"><?= $banner['description'] ?></textarea>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="form-group">
                ...
                <input type="number" id="ad-bn-ed-priority" class="form-control" name="priority"
                    placeholder="Input priority" min="1" value="<?= $banner['priority'] ?>"
                    onkeyup="validateInt(this, 'Priority');">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" name="current-image" id="" class="form-control"
                        value="<?= $banner['image'] ?>">
