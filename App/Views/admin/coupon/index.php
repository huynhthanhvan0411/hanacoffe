...
<div class="alert alert-danger" id="error-delete-coupon">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"
        onclick="document.getElementById('error-delete-coupon').style.display='none'">&times;</button>
...
<div class="alert alert-success" id="success-delete-coupon">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"
        onclick="document.getElementById('success-delete-coupon').style.display='none'">&times;</button>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <a href="./?module=admin&controller=coupon&action=edit&id=<?= $model['id'] ?>"
                    class="btn btn-sm btn-success">
                    <i class="fas fa-edit"></i>
                </a>

                <a href="./?module=admin&controller=coupon&action=delete&id=<?= $model['id'] ?>"
