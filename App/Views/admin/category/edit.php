...
<div class="alert alert-success" id="success-edit-category">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"
        onclick="document.getElementById('success-edit-category').style.display='none'">&times;</button>
    <?= $message['success-edit'] ?? '' ?>
</div>
<?php } ?>

<form action="./?module=admin&controller=category&action=update&id=<?= $_GET['id'] ?>" method="POST" role="form"
    name="categoryForm" onsubmit="return validateCategoryForm();">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="Input name" value="<?= $category['name'] ?>"
            id="ad-ctg-cr-name" onkeyup="validateNotEmpty(this, 'Category name');">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" value="1" class="form-control" name="priority" placeholder="Input name"
                <?= $category['priority'] ?> id="ad-ctg-cr-priority" onkeyup="validateInt(this, 'Priority');">
