        ...
        <div class="row">
                    ...
                    <form method="POST" action="./?controller=checkout&action=process" name="checkoutForm"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="note" rows="5"
                                placeholder="Notes on your order"></textarea>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <p> <i class="discount fas fa-phone-alt mr-2" style="font-size: 13px;"></i>(883) 876
                                    8973
                                    <i class="discount far fa-envelope ml-4 mr-2"></i>hana@support.com
                                </p>
                            </td>
                        </tr>
                    </tfoot>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="error-block cart-empty">
                    ...
                    <p><a href="./?controller=product&action=allProducts" class="btn-root ptc-btn border-root">Continue
                            shopping</a>
                    </p>
