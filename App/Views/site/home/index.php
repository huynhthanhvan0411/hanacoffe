...
<div class="alert alert-danger" style="margin-bottom: 0;" id="all-error">
    <button onclick="document.getElementById('all-error').style.display='none'" type="button" class="close"
...
<div class="alert alert-success" style="margin-bottom: 0;" id="success-login">
    <button onclick="document.getElementById('success-login').style.display='none'" type="button" class="close"
        data-dismiss="alert" aria-hidden="true">&times;</button>
...
<div class="alert alert-warning" style="margin-bottom: 0;" id="success-add-to-cart">
    <button onclick="document.getElementById('success-add-to-cart').style.display='none'" type="button" class="close"
        data-dismiss="alert" aria-hidden="true">&times;</button>
    <?= $success['add_to_cart'] ?? '' ?>
</div>
<?php } ?>
