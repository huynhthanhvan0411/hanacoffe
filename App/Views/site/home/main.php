<main>
                    ...
                    <ul id='quick-shop-list'>
                        <li>
                            ...
                            <div class="bread-desc">
                                ...
                                <a href="./?controller=product&action=allProducts"><button><span>SHOP NOW</span><img
                                            src="./public/site/img/home/logo/right.png" alt=""></button></a>
                                <div class="basket">
                                    <img src="./public/site/img/home/images/shopbuy1.png" alt="">
                                </div>
                            </div>
            ...
            <ul>
                ...
                <li class="offer-info">
                    <div>
                        ...
                        <h5 class="offer-price"><span
                                class="strikeout">$<?= number_format($offer_pro['price'], 2, '.', '') ?></span> Now only
                        ...
                        <a class="offer-btn btn-root ptc-btn border-root" style="margin-top: 15px; position: absolute"
                            href="./?controller=product&action=productDetail&id=<?= $offer_pro['id'] ?>">
                            BUY NOW
                        </a>
    ...
    <section class="latest-products p-50">
        <div class="container-fluid section-main">
            <div class="content-title-block">
                ...
                <p class="block-motto"><span>OUR BEST Cafe</span></p>
            </div>
                    ...
                    <ul id='new-pro-list'>
                        ...
                        <li>
                            ...
                            <div class="new-pro-block">
                                ...
                                <a id="add-to-cart-btn<?= $product['id'] ?>" class="swalDefaultSuccess "
                                    onclick="onAddToCartAjax(<?= $product['id'] ?>)">
    ...
    <section class="testimonial">
        <div class="container-fluid section-main">
            <div class="content-title-block">
                <p class="block-title">What our CEO saying?</p>
                ...
                <div class="carousel-inner" id="testimonial-list" role="listbox">
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                ...
                                <p> Hana is best choice for you and your family
                                    <br>
                                </p>
                                <span id="star-icon"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                        class="fas fa-star"></i></span>
                                <h5> Thanh Van Huynh </h5>
                    ...
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                <img src="./public/site/img/home/customer/testimonial.png">
                                <p> Hana always next to you every where, everything forever
                                    <br>
                                </p>
                                <span id="star-icon"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                    ...
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                <img src="./public/site/img/home/customer/testimonial.png">
                                <p> Love yourself, love life, love Hana
                                    <br>
                                </p>
                                <span id="star-icon"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                        class="fas fa-star"></i><i class="fas fa-star"></i><i
                                        class="fas fa-star"></i></span>
                                <h5> Duong Tung Nguyn </h5>
